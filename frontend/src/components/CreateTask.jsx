  ...
  return (
    <article className="flex flex-col gap-6 md:py-6 md:px-10 py-4 px-6 bg-bg-light dark:bg-bg-dark w-[90%] md:w-[75%] h-[75%] rounded-lg">
      ...
      <div className="flex gap-10 justify-end">
        <button className="border-b-2 px-4 opacity-80 border-text-light-lighter dark:border-text-dark-lighter text-text-light-lighter dark:text-text-dark-lighter font-semibold">Cancelar</button>
        <Button function={props.function} content="Crear" />
      </div>
    </article>
  );
}
